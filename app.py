...
st.title('⚡ Household Power Usage Dashboard')
...
if token:
    ...
    if df is not None and not df.empty:
        ...
        # Tabs
        tab1, tab2, tab3, tab4, tab5 = st.tabs(['📈 Overview', '📊 Data Table', '📅 Daily Summary', '⏰ Hourly Stats', '🔋 Car Charge'])
        ...
        st.error('⚠️ Unable to fetch power data. Please check your token.')
